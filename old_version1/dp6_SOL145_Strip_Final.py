...
if n == 1 :
    bdf145_filename_out = os.path.join('MA_final/DP6/sol145/strip/sol145_strip_DP6_M1.bdf')
if n == 2 :
    bdf145_filename_out = os.path.join('MA_final/DP6/sol145/strip/sol145_strip_DP6_M2.bdf')
if n == 3 :
    bdf145_filename_out = os.path.join('MA_final/DP6/sol145/strip/sol145_strip_DP6_M3.bdf')
