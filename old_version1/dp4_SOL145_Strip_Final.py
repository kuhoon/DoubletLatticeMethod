...
rrfFileName_M1 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M1_no_batteries/m1_redRF.dat"
rrfFileName_M2 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M2_max_batteries_wing box center/m2_redRF.dat"
rrfFileName_M3 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M3_max_batteries_front spar center/m3_redRF.dat"
#v_min = stall speed
#v_max = dive speed
...
if n == 1 :
    bdf145_filename_out = os.path.join('MA_final/DP4/sol145/strip/sol145_strip_DP4_M1.bdf')
if n == 2 :
    bdf145_filename_out = os.path.join('MA_final/DP4/sol145/strip/sol145_strip_DP4_M2.bdf')
if n == 3 :
    bdf145_filename_out = os.path.join('MA_final/DP4/sol145/strip/sol145_strip_DP4_M3.bdf')
