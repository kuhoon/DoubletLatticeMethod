...
M1 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M1_no_batteries/data_masses.dat"
M2 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M2_max_batteries_wing box center/data_masses.dat"
M3 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M3_max_batteries_front spar center/data_masses.dat"
...
v3FileName = "Wing_data_MA_Beechraft1900D_230218/wing_data/REF/v3_637_259591.dat"
rrfFileName_M1 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M1_no_batteries/m1_redRF_637_259591.dat"
rrfFileName_M2 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M2_max_batteries_wing box center/m2_redRF_637_259591.dat"
rrfFileName_M3 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M3_max_batteries_front spar center/m3_redRF_637_259591.dat"

v3FileName_narrow = "Wing_data_MA_Beechraft1900D_230218/wing_data/REF/v3_219591_259591.dat"
rrfFileName_n_M1 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M1_no_batteries/m1_redRF_219591_259591.dat"
rrfFileName_n_M2 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M2_max_batteries_wing box center/m2_redRF_219591_259591.dat"
rrfFileName_n_M3 = "Wing_data_MA_Beechraft1900D_230218/wing_data/DP4/M3_max_batteries_front spar center/m3_redRF_219591_259591.dat"
...
y2 = np.linspace(0, 0.8, 9)
y22 = np.linspace(0.8, 1, 5)
box2 = np.unique(np.concatenate((y2, y22)))
print(len(box2))
print(box2)
y3 = np.linspace(0, 0.14, 8)
y33 = np.linspace(0.14, 0.5, 12)
y333 = np.linspace(0.5, 0.8, 12)
y3333 = np.linspace(0.8, 0.92, 7)
y33333 = np.linspace(0.92, 0.96, 5)
y333333 = np.linspace(0.96, 1, 6)
box3 = np.unique(np.concatenate((y3, y33, y333, y3333, y33333, y333333)))
print(len(box3))
print(box3)
...
if n == 1 :
    bdf145_filename_out = os.path.join('../MA_final/DP4/sol145/dlm/sol145_dlm_DP4_M1_global.bdf')
if n == 2 :
    bdf145_filename_out = os.path.join('../MA_final/DP4/sol145/dlm/sol145_dlm_DP4_M2_global.bdf')
if n == 3 :
    bdf145_filename_out = os.path.join('../MA_final/DP4/sol145/dlm/sol145_dlm_DP4_M3_global.bdf')
