...
y1 = np.linspace(0, 1, 14) # same, 12 strip
y2 = np.linspace(0, 1, 34) # same, 32 strip
...
if n == 00 :
    bdf145_filename_out = os.path.join('../MA_final/referenz/sol145/strip/test2/sol145_strip2_000.bdf')
if n == 25 :
    bdf145_filename_out = os.path.join('../MA_final/referenz/sol145/strip/test2/sol145_strip2_025.bdf')
if n == 50 :
    bdf145_filename_out = os.path.join('../MA_final/referenz/sol145/strip/test2/sol145_strip2_050.bdf')
if n == 100 :
    bdf145_filename_out = os.path.join('../MA_final/referenz/sol145/strip/test2/sol145_strip2_100.bdf')
