...
model_path = os.path.join(cw_path, 'MA_final/DP4/sol103/ungekoppelt/sol103_dp4_m3_uncoupled.op2')
...
x_data = np.delete(sol103.eigenvectors[1].modes,[1, 4, 8, 10])
y_data = np.delete(sol103.eigenvectors[1].mode_cycles, [1, 4, 8, 10])
...
plt.title('SOL103_M3 Mode Frequency')
plt.grid()
...
plt.savefig('MA_final/DP4/sol103/ungekoppelt/sol103_dp4_m3_uncoupled.png')
plt.show()