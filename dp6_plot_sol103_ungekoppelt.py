...
model_path = os.path.join(cw_path, 'MA_final/DP6/sol103/ungekoppelt/sol103_dp6_m1_uncoupled.op2')
...
# colors[3] = 'g'  # 6번 요소 막대는 빨간색으로 변경
colors[4] = 'b'  # 6번 요소 막대는 빨간색으로 변경
...
plt.savefig('MA_final/DP6/sol103/ungekoppelt/sol103_dp6_m1_uncoupled.png')
plt.show()