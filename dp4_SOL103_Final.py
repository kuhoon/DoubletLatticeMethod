...
if n == 1 :
    if nn == 1: # Entkopplung
        bdf_filename_out = os.path.join('MA_final/DP4/sol103/ungekoppelt/sol103_DP4_M1_uncoupled.bdf')
    if nn == 2: # Kopplung
        bdf_filename_out = os.path.join('MA_final/DP4/sol103/kopplung/sol103_DP4_M1_coupled.bdf')
if n == 2 :
    if nn == 1: # Entkopplung
        bdf_filename_out = os.path.join('MA_final/DP4/sol103/ungekoppelt/sol103_DP4_M2_uncoupled.bdf')
    if nn == 2: # Kopplung
        bdf_filename_out = os.path.join('MA_final/DP4/sol103/kopplung/sol103_DP4_M2_coupled.bdf')
if n == 3 :
    if nn == 1: # Entkopplung
        bdf_filename_out = os.path.join('MA_final/DP4/sol103/ungekoppelt/sol103_DP4_M3_uncoupled.bdf')
    if nn == 2: # Kopplung
        bdf_filename_out = os.path.join('MA_final/DP4/sol103/kopplung/sol103_DP4_M3_coupled.bdf')
