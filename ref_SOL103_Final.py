...
if n == 00 :
    with open("Wing_data_MA_Beechraft1900D_230218/wing_data/REF/fuel_000/data_masses.dat") as datFile:
    ...
    with open("Wing_data_MA_Beechraft1900D_230218/wing_data/REF/fuel_025/data_masses.dat") as datFile:
        lumpValueList = [data.split() for data in datFile]
        del lumpValueList[0]
        for v in lumpValueList:
            conm1List.append(v[0])  # conm1list 1-100
    ...
    with open("Wing_data_MA_Beechraft1900D_230218/wing_data/REF/fuel_050/data_masses.dat") as datFile:
        lumpValueList = [data.split() for data in datFile]
        del lumpValueList[0]
        for v in lumpValueList:
            conm1List.append(v[0])  # conm1list 1-100
    ...
    with open("Wing_data_MA_Beechraft1900D_230218/wing_data/REF/fuel_100/data_masses.dat") as datFile:
        lumpValueList = [data.split() for data in datFile]
        del lumpValueList[0]
        for v in lumpValueList:
            conm1List.append(v[0])  # conm1list 1-100
...
with open("Wing_data_MA_Beechraft1900D_230218/wing_data/_general/data_nodes.dat") as datFile:
...
with open("Wing_data_MA_Beechraft1900D_230218/wing_data/_general/data_elements.dat") as datFile:
