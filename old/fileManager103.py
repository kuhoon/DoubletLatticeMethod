...
model.add_spc1(50, '123456', [1])
model.add_spcadd(2, 50)

# spc = SPC1(50, '123456', [1])
# spc.write_card(size=8, is_double=False)
# print(spc.validate())
# spcAdd = SPCADD(spcAdd_id, spc_id, '')
# spcAdd.write_card(size=8, is_double=False)
...
model.validate()
bdf103_filename_out = os.path.join('sol103_ver03_usingOwnFile.bdf')
