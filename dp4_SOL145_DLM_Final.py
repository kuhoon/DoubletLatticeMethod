...
if n == 1 :
    bdf145_filename_out = os.path.join('MA_final/DP4/sol145/dlm/sol145_dlm_DP4_M1.bdf')
if n == 2 :
    bdf145_filename_out = os.path.join('MA_final/DP4/sol145/dlm/sol145_dlm_DP4_M2.bdf')
if n == 3 :
    bdf145_filename_out = os.path.join('MA_final/DP4/sol145/dlm/sol145_dlm_DP4_M3.bdf')
