...
model_path = os.path.join(cw_path, 'MA_final/DP4/sol103/kopplung/sol103_dp4_m3_coupled.op2')
...
plt.savefig('MA_final/DP4/sol103/kopplung/sol103_dp4_m3_coupled.png')
plt.show()